...
const sourceHashes=Object.fromEntries(await Promise.all(['src/engine.js','src/kernel-selection.js','src/gemm-tiles.js','kernels/numeric.cuh','kernels/gemm-half.cu','kernels/gemm-wide.cu','kernels/attention-normalized.cu','kernels/fast-half.cuh','kernels/vector-f13.cuh','kernels/lookup.cu','vendor/webcuda/compiler/compiler.js','vendor/webcuda/compiler/parser.js','vendor/webcuda/compiler/loop-unroll.js','vendor/webcuda/compiler/vector-constructor.js','vendor/webcuda/compiler/cpu-oracle.js'].map(async file=>[file,createHash('sha256').update(await readFile(file)).digest('hex')])));
